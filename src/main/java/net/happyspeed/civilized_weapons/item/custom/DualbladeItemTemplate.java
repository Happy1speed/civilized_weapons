...
public class DualbladeItemTemplate extends AdvancedWeaponTemplate {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(Text.translatable("tooltip.civilized_weapons.DualbladeSweepFull.tooltip").formatted(Formatting.AQUA));

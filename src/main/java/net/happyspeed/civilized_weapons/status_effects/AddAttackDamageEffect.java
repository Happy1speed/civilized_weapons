...
public class AddAttackDamageEffect extends StatusEffect {
    Item currentWeapon = null;
    public AddAttackDamageEffect() {
    ...
    public void onApplied(LivingEntity entity, AttributeContainer attributes, int amplifier) {
        if (entity instanceof PlayerEntity player) {
            this.currentWeapon = player.getMainHandStack().getItem();
        }
    ...
    public void applyUpdateEffect(LivingEntity entity, int amplifier) {
        if (entity instanceof PlayerEntity player) {
            if (this.currentWeapon != null) {
                if (this.currentWeapon != player.getMainHandStack().getItem()) {
